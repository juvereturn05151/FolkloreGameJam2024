...
namespace Drakkar
{
    ...
    public class Il2CppSetOptionAttribute : Attribute
    {
        ...
        {
		#if !IL2CPP_DONT_OPTIMIZE
		#if DO_NULL_CHECKS
			if (Option==Option.NullChecks) return;
		#endif
		#if DO_BOUNDS_CHECKS
			if (Option==Option.ArrayBoundsChecks) return;
		#endif
		#if DO_DIVIDEBYZERO_CHECKS
			if (Option==Option.DivideByZeroChecks) return;
		#endif
			Option=option;
            Value=value;
		#endif
